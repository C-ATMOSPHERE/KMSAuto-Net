...
// Type: KMSAuto_Net.NoAutoSettings
...
{
  [DesignerGenerated]
  public class NoAutoSettings : Form
  {
    private IContainer components;

    public NoAutoSettings()
    {
      this.Load += new EventHandler(this.NoAutoSettings_Load);
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (NoAutoSettings);
      this.StartPosition = FormStartPosition.Manual;
      this.Text = nameof (NoAutoSettings);
    ...
    private void NoAutoSettings_Load(object sender, EventArgs e)
    {
      this.Text = Lang.TabPageText2 + " NoAuto";
      this.CheckBox1.Text = Lang.NoAutoModeCheckBoxTxt;
      if (MyProject.Forms.Form1.NoAutoNoKms)
    ...
    private void CheckBox1_CheckedChanged(object sender, EventArgs e)
    {
      if (MyProject.Forms.Form1.LoadingProgramm)
        return;
      MyProject.Forms.Form1.NoAutoNoKms = this.CheckBox1.Checked;
      this.Close();
    }
  }
}
